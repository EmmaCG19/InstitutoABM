...
namespace IntranetInstituto.Controllers
{
    ...
    public class EspecialidadesController : ControllerBase
    {
        ...
        public EspecialidadesController(InstitutoDBContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != especialidad.CodEspecialidad)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Especialidad>> PostEspecialidad(Especialidad especialidad)
        {
            ...
            return CreatedAtAction("GetEspecialidad", new { id = especialidad.CodEspecialidad }, especialidad);
        }
        ...
        {
            return _context.Especialidades.Any(e => e.CodEspecialidad == id);
        }
    }
}
